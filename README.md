...
```
az containerapp create -n invoicetestscheduleraz -g MscResProj --image docker.io/x00159358/invoicemgrtestscheduler:1.0.0-SNAPSHOT --cpu 2 --memory 4.0 --min-replicas 3 --max-replicas 5 --env-vars ENDPOINT=https://invoicemgr.northeurope-1.eventgrid.azure.net/api/events TPS=30 POST_TYPE=CLOUDEVENT
```
